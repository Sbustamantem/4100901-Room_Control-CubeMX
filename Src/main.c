...
ring_buffer_t keypad_rb; // Variable to hold received data
/* USER CODE END PV */
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LD2_Pin PA7 KEYPAD_R1_Pin */
  ...
  /*Configure GPIO pins : KEYPAD_R2_Pin KEYPAD_R4_Pin */
  GPIO_InitStruct.Pin = KEYPAD_R2_Pin|KEYPAD_R4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
